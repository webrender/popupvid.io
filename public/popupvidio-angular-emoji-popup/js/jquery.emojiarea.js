...
(function($, window, document) {
	...
	EmojiArea.createIcon = function(emoji, menu) {
		...
		style += 'background-size:' + scaledWidth + 'px ' + scaledHeight
				+ 'px;';
		return '<img src="popupvidio-angular-emoji-popup/img/blank.gif" class="img" style="'
	...
	var EmojiMenu = function() {
		...
		this.emojiarea = null;
		this.$menu = $('<div>');
		this.$menu.addClass('emoji-menu animated');
		//this.$menu.hide();
		...
		$('.card-settings-emojipicker').append(this.$menu);
	...
	EmojiMenu.prototype.onItemSelected = function(emoji) {
		var scope = angular.element('.card-emoji').scope();
	...
	EmojiMenu.prototype.hide = function(callback) {
		...
		this.visible = false;
		// this.$menu.hide("fast");
		this.$menu.removeClass('fadeIn').addClass('fadeOut');
	};
	...
	EmojiMenu.prototype.show = function(emojiarea) {
		...
		this.reposition();
		// this.$menu.show("fast");
		this.$menu.removeClass('fadeOut').addClass('fadeIn').css('display','block');
		/*
		 * MODIFICATION: Following 3 lines were added by Igor Zhukov, in order
